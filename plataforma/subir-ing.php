<?php include('includes/botones.php');?>
        ...
        <form action='procesar-ing.php?u=admin-master.php' method='post' enctype='multipart/form-data' class="container">
            ...
            <h5 class="white-text">Educación para la Democrácia Sexto</h5>
            <input type='hidden' name='r5' value='<?php echo $path?>/06. GRADO SEXTO/Sexto 2/Educación para la Democracia/'/>
            <input type='hidden' name='r6' value='<?php echo $path?>/06. GRADO SEXTO/Sexto 3/Educación para la Democracia/'/>
