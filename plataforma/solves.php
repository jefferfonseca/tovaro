...
if ($_SESSION["autentificado"] != "SI") {
    ...
    <section>
        <form action="" method="POST">
            ...
            <input type="submit" class="btn" name="periodo" value="Tercer Periodo">
            <input type="submit" class="btn" name="periodo" value="Cuarto Periodo">

            <a href="logout.php" class="right white-text">Cerrar sesión</a>

            <a href="subir-ing.php" class="btn right indigo darken-4 ">Subir</a>
